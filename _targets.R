...
list(
  ...
  # Fit, check, and plot main model with random slopes included and Steele priors for Standarised Mean Changes
  ...
  # Fit, check, and plot main model with random slopes included and Steele priors for Log Response Ratio
